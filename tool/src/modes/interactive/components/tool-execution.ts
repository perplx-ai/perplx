...
export class ToolExecutionComponent extends Container {
  ...
  markExecutionStarted(): void {
    ...
    if (this.toolName === 'bash') {
      if (this.bashStartedAt !== undefined) return;
  ...
  private ensureBashElapsedTimer(): void {
    if (this.toolName !== 'bash' || !this.isPartial || this.bashStartedAt === undefined || this.bashElapsedInterval) return;
  ...
  private formatToolExecution(): string {
    ...
    if (this.toolName === 'read') {
      ...
      const writeStatus =
        this.isPartial && this.executionStartedAt
          ? theme.fg('muted', ' writing…')
          : !this.isPartial && this.result && !this.result.isError
            ? theme.fg('muted', ' ✓')
            : '';
      ...
      const firstChangedLine =
        (this.editDiffPreview && 'firstChangedLine' in this.editDiffPreview ? this.editDiffPreview.firstChangedLine : undefined) ||
      ...
      text = `${theme.fg('toolTitle', theme.bold('edit'))} ${pathDisplay}${editStatus}`;
