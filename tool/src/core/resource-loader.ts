...
export class DefaultResourceLoader implements ResourceLoader {
  ...
  async reload(): Promise<void> {
    ...
    const getEnabledPaths = (resources: Array<{ path: string; enabled: boolean; metadata: PathMetadata }>): string[] =>
  ...
  private normalizeExtensionPaths(entries: Array<{ path: string; metadata: PathMetadata }>): Array<{ path: string; metadata: PathMetadata }> {
  ...
  private updateSkillsFromPaths(skillPaths: string[], extensionPaths: Array<{ path: string; metadata: PathMetadata }> = []): void {
  ...
  private updatePromptsFromPaths(promptPaths: string[], extensionPaths: Array<{ path: string; metadata: PathMetadata }> = []): void {
  ...
  private updateThemesFromPaths(themePaths: string[], extensionPaths: Array<{ path: string; metadata: PathMetadata }> = []): void {
  ...
  private applyExtensionMetadata(extensionPaths: Array<{ path: string; metadata: PathMetadata }>, resourcePaths: string[]): void {
